  ...
  const handleConfirmPay = () => {
    ...
    window.handleCheckout = (message) => {
      if (message === "success") {
        ...
        axios
          .post("/terraNet/refill_customer_terranet", postParamettersPay)
          .then((response) => {
    ...
    <>
              ...
              <div className="paymentConfirmation">
                <div className="MyBundleBody">
                  ...
                  <div className="MoreInfo">
                    ...
                    <div className="value">
                      L.L{" "}
                      {parseInt(selectedProduct?.OriginalHT).toLocaleString()}
                    </div>
                  </div>
                  <div className="MoreInfo">
                    ...
                    <div className="value">
                      L.L{" "}
                      {parseInt(
                        selectedProduct?.Price - selectedProduct?.OriginalHT
                      ).toLocaleString()}
                    </div>
                  </div>
                  <div className="br"></div>
      ...
      >
        ...
        <div className="MyBundleBody">
          ...
          <div className="mainDesc text-center fw-bold my-3 fs-6">
            {selectedProduct?.Description}
          </div>
