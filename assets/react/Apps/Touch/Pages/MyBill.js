      ...
      <div id="MyBill">
        ...
        <div className="PinSection" onClick={handlePincodeClick}>
          ...
          <div className="Pincode">
            ...
            <input ref={inputRef} type="text" value={getPostpaidData.pinCode ? getPostpaidData.pinCode.join("") : ""} onChange={handleInputChange} style={{ opacity: 0, position: "absolute", left: "-10000px" }} />
          </div>
        </div>
