...
const BottomSlider = () => {
  ...
  return (
   <div id="BottomSliderContainer" style={{ opacity: isloading ? "0.5" : "1" , display: modalData?.isShow ? "none" : "block"}}>
        ...
        {bottomSlider?.name == "successPrepaidSlider" && (
          <div id={bottomSlider?.name}>
            ...
            <div className="descriptio">
              ...
              {bottomSlider?.data?.priceUSD} Alfa recharge card.
            </div>
            ...
            <button
              ...
              onClick={() => {
                handleShare(
                  bottomSlider?.data?.voucherCodeClipboard,
          ...
          <div id={bottomSlider?.name}>
            ...
            <div className="MoreInfo">
              ...
              <div className="value1">
                $ {bottomSlider.data.displayData.InformativeOriginalWSAmount}
              </div>
            </div>
            ...
            <div className="MoreInfo">
              ...
              <div className="value1">
                L.L{" "}
                {parseInt(
                  bottomSlider.data.displayData.Amount
                ).toLocaleString()}
              </div>
            </div>
            ...
            <div className="MoreInfo">
              ...
              <div className="value1">
                L.L {parseInt(bottomSlider.data.displayedFees).toLocaleString()}
              </div>
            </div>
            <div className="br"></div>
            ...
            <div className="MoreInfo">
              ...
              <div className="value2">
                L.L{" "}
                {parseInt(
                  bottomSlider.data.displayData.TotalAmount
                ).toLocaleString()}
              </div>
            </div>
