        ...
        <>
          ...
          {parameters?.deviceType === "Iphone" && (
            ...
            <div className="stepsToRecharge">
              ...
              <div className="steps">
                <div className="dot"></div>
                <div className="textStep">
                  Tap on ‘Use QR Code’ then ‘Open Photos’ & select the
                  screenshot.
                </div>
              </div>
              <div className="steps">
          ...
          {parameters?.deviceType === "Android" && (
            ...
            <div className="stepsToRecharge">
              ...
              <div className="steps">
                <div className="dot"></div>
                <div className="textStep">
                  Go to the eSIM management settings of your phone & scan the QR
                  code to install your eSIM.
                </div>
              </div>
              <div className="steps">
                <div className="dot"></div>
          ...
          <div className="stepsToRecharge mt-4">
            ...
            <div className="steps mt-2">
              <div className="dot"></div>
              <div className="textStep">
                Select your eSIM under ‘SIM card manager’.
              </div>
            </div>
            <div className="steps">
              <div className="dot"></div>
              <div className="textStep">
                Make sure the toggle for the eSIM you purchased is switched ON.
              </div>
            </div>
            <div className="steps">
              <div className="dot"></div>
              <div className="textStep">
                Go to ‘Mobile Networks’ & select the network that connected to
                your phone initially.
              </div>
            </div>
            <div className="steps">
              <div className="dot"></div>
          ...
          {parameters?.deviceType === "Android" && (
            ...
            <div className="stepsToRecharge">
              <div className="steps">
                <div className="dot"></div>
                <div className="textStep">
                Copy the Activation Code found on top.
                </div>
              </div>
              <div className="steps">
                <div className="dot"></div>
                <div className="textStep">
                Go to the eSIM management settings of your phone & paste the Activation Code to install your eSIM.
                </div>
              </div>
              <div className="steps">
                <div className="dot"></div>
              ...
              <div className="steps">
                <div className="dot"></div>
                <div className="textStep">
                Choose the eSIM plan as your default line for Cellular Data & do not turn on ‘Allow Cellular Data Switching’ to prevent charges on your other line.
                </div>
              </div>
            </div>
            <div className="titleDes">
