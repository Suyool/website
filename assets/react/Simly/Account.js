...
const Account = ({
    ...
    return (
                                ...
                                <div key={index} className="accountcomp">
                                    <div className="accountCard">
                                        <div className="titleaccount">
                                            {data.countryImage ? <img src={data.countryImage}/> :
       ...
       a 15.9155 15.9155 0 0 1 0 -31.831"
                                            ...
                                            <div className="radio">
                                                <input type="checkbox" id="eSim" name="eSim" value="eSim"
                                                       checked={data.sim.size !== data.sim.consumed} disabled/>
                                                <label className="esim">eSim is still valid</label>
                                                <br/>
                                                <input type="checkbox" id="plans" name="plans" value="plan"
                                                       checked={data.sim.size === data.sim.consumed} disabled/>
