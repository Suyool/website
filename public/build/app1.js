(self["webpackChunksuyool"] = self["webpackChunksuyool"] || []).push([["app1"],{
...
if (document.getElementById("emailForm")) {
  ...
  var form = document.getElementById("emailForm"); // Get the email status element

  var emailStatus = document.getElementById("emailStatus");
  var emailTitle = document.getElementById("emailTitle");
  var emailBtn = document.getElementById("emailBtn"); // Add an event listener to the form submission
...
function getTheApp(position, downloadAppUrl) {
  ...
  var eventLabel = ""; //If the downloadAppUrl isset uset it, otherwise set the default value ''

  var downloadAppUrl = typeof downloadAppUrl != "undefined" ? downloadAppUrl : ""; //Call the googleFacebookEvents to execute Google and Facebook events
  ...
  if (window.screen.width > 768) {// console.log(window.screen.width );
  } else {
    //Get the Mobile Operating System
    var osMobile = getMobileOperatingSystem(); //If the Download App URL isset use it

    if (downloadAppUrl != "") {
      location = downloadAppUrl; //Otherwise check the OS and call the Apple or Play Store URL
    } else {
      location = DefaultDownloadLink; // //If IOS
      // if(osMobile == 'iOS'){
...
function clickOne(downloadAppUrl, conversion_code, uri) {
  if (!clicked_once) {
    clicked_once = true;
    console.log("ok");
    $(".conversion-button").css("margin-top", "20px"); // gtag('event', 'conversion', {'send_to': 'AW-799970313/'+conversion_code});
  } else {
...
if (document.querySelector(".open-suyool-account")) {
  var open_suyool_account = document.querySelectorAll(".open-suyool-account");
...
if (document.querySelector(".mobileMode .OpenYourSuyoolAccount")) {
  var _open_suyool_account = document.querySelector(".mobileMode .OpenYourSuyoolAccount");

  _open_suyool_account.addEventListener("click", function () {
    clickOne("https://suyoolapp.page.link/app", "", "/");
  });
...
if (document.getElementById("chatwithteam")) {
  ...
  var salesLink = document.getElementById("chatwithteam"); // Define the mobile and desktop URLs
...
$(".submitTextDownloadAppBtn").on("click", function (e) {
  ...
  e.preventDefault(); // Get the mobile number from the input field

  var mobileNumber = $(this).closest(".input-main-cont").find(".mobileTextDownloadApp").val(); // Send an AJAX request to the server
  ...
  $.ajax({
    ...
    success: function success(response) {
      ...
      $("#invitationModal .modal-body").append("<p>" + response.RespDesc + "</p>"); // Modify the button label based on the RespCode value
...
$(document).ready(function () {
  ...
  $(".mobileTextDownloadApp").on("input", function (event) {
    ...
    var parentDivision = $(this).closest(".input-main-cont").parent().attr("class"); //Main division of the mobile input

    var mainDivision = ""; //Check if the parent division is skash-more-than-cash-section - home-v3

    if (parentDivision.indexOf("invitation-card-section-bottom") > 0) {
      //Main division of the form
      mainDivision = ".invitation-card-section-bottom"; //Check if the parent division is invitation-card-section-top - invitation-card
...
if (document.querySelector(".loaderTopUp")) {
  var element = document.getElementById("submitTopUp");
...
if (document.querySelector(".actionApp")) {
  var actionApp = document.querySelector(".actionApp");
...
if (document.querySelector(".actionBrowser")) {
  var actionBrowser = document.querySelector(".actionBrowser");
...
if (document.querySelector(".back")) {
  var action = document.querySelector(".back");
...
if (document.querySelector(".copy-to-clipboard")) {
  ...
  var copyBtn = document.querySelector(".copy-to-clipboard"); // Get the value of the 'data-to-copy' attribute

  var copyText = copyBtn.getAttribute("data-to-copy"); // Add a click event listener to the button

  copyBtn.addEventListener("click", function () {
    // Create a new textarea element to hold the copied text
    var textarea = document.createElement("textarea");
    textarea.value = copyText;
    document.body.appendChild(textarea); // Select the text in the textarea and copy it to the clipboard

    textarea.select();
    document.execCommand("copy"); // Remove the textarea element from the DOM

    document.body.removeChild(textarea); // Show a success message to the user
...
if (document.querySelector(".generate-code")) {
  document.querySelector(".generate-code").addEventListener("click", function () {
    var tag = document.querySelector(".generate-code");
...
if (document.getElementById("contactusForm")) {
  var _form = document.getElementById("contactusForm");
  ...
  _form.addEventListener("submit", function (event) {
    ...
    fetch(_form.action, {
      ...
      console.log(data); // if(data.success == "Invalid Email"){
      //   emailStatus.textContent = "Invalid Email";
      //   emailTitle.textContent = "Rejected";
      //   emailBtn.textContent="Cancel";
      // }else{
