(self["webpackChunkelnashra"] = self["webpackChunkelnashra"] || []).push([["app1"],{
...
function googleFacebookEvents(eventNameKey, eventName, eventCategory, eventLabel) {
  ...
  var eventResolution = ''; //If Ipad - Add "Ipad - " to the eventLabel

  if (window.screen.width > 767 && window.screen.width < 769) {
    eventResolution = 'Ipad - '; //If Mobile - Add "Mobile - " to the eventLabel
  } else if (window.screen.width < 992) {
    eventResolution = 'Mobile - '; //If Desktop - Add "Desktop - " to the eventLabel
  } else {
  ...
  gtag('event', eventName, {
    ...
    'event_label': eventResolution + eventLabel
  }); //Facebook Pixel
...
function getTheApp(position, downloadAppUrl) {
  ...
  googleFacebookEvents('Action', 'Get The APP', 'App download', eventLabel); //If width > 992 - scroll to the bottom section to download the app
...
function clickOne(downloadAppUrl, conversion_code, uri) {
  if (!clicked_once) {
    ...
    gtag('event', 'conversion', {
      'send_to': 'AW-799970313/' + conversion_code
    });
  } else {
...
if (document.querySelector('.open-suyool-account')) {
  var open_suyool_account = document.querySelector('.open-suyool-account');
