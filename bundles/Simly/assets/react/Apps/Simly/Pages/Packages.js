    ...
    return (
        <>
            <div className="container">
                <SearchBar searchQuery={searchQuery} handleSearchChange={handleSearchChange} dispatch={dispatch}/>
                {view !== "offers" &&
                <>
            ...
            {(simlyData.isPackageItem && simlyData?.SelectedCountry && view !== "offers") && (
            ...
            {!simlyData.isPackageItem && (
                <>
                    ...
                    {view === "regions" && <Regions simlyData={simlyData} handleClick={handleClick}/>}
                    {view === "global" && <Global simlyData={simlyData} handleClick={handleClick}/>}
                    {view === "countries" && (
                        <>
                            {isLoadingData ? (
                                <CustomContentLoader/>
                            ) : view === "countries" &&
                                <Countries filteredData={filteredData} handleClick={handleClick}
