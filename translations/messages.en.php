...
return [
    ...
    //usj
    "USJ_IS_BRINGING_YOUR_PAY"=>"Always at the forefront of technology, USJ is bringing your<br> pay to the ultimate digital account: the first secure and <br> independent Lebanese online platform!",
    ...
    "FOR_AS_MANY_TIMES_AS_YOU_WANT_UP_TO_YOUR_WALLET_LIMIT"=>"Fund will be instantly available in their Suyool wallet.",
    ...
    "ANYWHERE_IN_THE_WORLD_WHILE_BENEFITING_FROM_"=>"Don’t forget to make use of the exclusif benefits provided, including access to lounges and much more.",
    "PAY_WITH_SUYOOL_QR"=>"Pay with Suyool QR",
    ...
    "FOR_AS_MANY_TIMES_AS_YOU_WANT_UP_TO_YOUR_WALLET_LIMIT"=>"Avoid risks linked to currency fluctuation, exchange only the needed amount.",
    ...
    "ANY_LEBANESE_CITIZEN_CAN_OPEN_A_SUYOOL_ACCOUNT"=>"Anyone can open a Suyool account with just their Lebanese mobile number & Lebanese identification. (Regulations apply)",
