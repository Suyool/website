...
return [
    ...
    "WHAT_ARE_THE_BENEFITS_FOR_HDF_EMPLOYEES"=>"Quels sont les avantages de Suyool pour les salariés de l’HDF ?",
    "YOU_WILL_BENEFIT_FROM_A_FREE_PLATINUM_MASTERCARD_HDF"=>"Au-delà de la simplicité et de la sécurité offertes par Suyool App, la carte Visa Platinum est fournie gratuitement. De plus, les salariés peuvent retirer de l’argent en espèces en USD ou en LL sans frais et dans la limite de leur salaire.",
    "IS_THERE_ANY_FEE_TO_GET_MY_SUYOOL_PLATINUM_MASTERCARD"=>"Y a-t-il des frais pour obtenir ma Suyool Debit Card ?",
    "YOUR_SUYOOL_MASTERCARD_WILL_BE_FREE_OF_CHARGE_HDF"=>"Votre Suyool Visa reste gratuite tant que vous êtes employé(e) de l’HDF.",
