...
class SimlyController extends AbstractController
{
    ...
    public function index(NotificationServices $notificationServices)
    {
        ...
        if (isset($_POST['infoString'])) {
            ...
            if ($notificationServices->checkUserForSimlyOnly($suyoolUserInfo[0], $suyoolUserInfo[2]) && $devicetype) {
                ...
                if ($this->session->get('isHavingCard')) {
                    $parameters['havingCard'] = true;
                } else {
                    $parameters['havingCard'] = false;
                }
    ...
    /**
     * @Route("/api/esim/getEsimDetails", name="api_GetEsimDetails")
     */
            ...
            return new JsonResponse([
                ...
                'data' => [
                    ...
                    'Popup' => [
                        ...
                        "globalCode" => 0,
                        "flagCode" => 0,
                        "Message" => "You have successfully purchased the $ {$simlyPlan['initial_price']} {$data['country']} eSIM.",
                        "InstallEsim" => true,
                        "isPopup" => true
                    ]
                ]
