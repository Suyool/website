...
class TouchController extends AbstractController
{
            ...
            if ($response[0]) {
                ...
                if ($PayResonse["errorinfo"]["errorcode"] == 0) {
                    ...
                    if ($suyooler->getType() == 2) {
                        ...
                        $notificationServices->addNotification($SuyoolUserId, $content, $params, $bulk, "*200*" . "112233445566" . "#");
                    }
                    //tell the .net that total amount is paid
    ...
    /**
     * @Route("api/touch", name="api_touch",methods="GET")
     */
     ...
     * Provider : BOB
     * Desc: Send Pin to user based on phoneNumber
     * @Route("api/touch/bill", name="api_touch_bill",methods="POST")
     */
    public function billApi(Request $request, BobServices $bobServices)
    {
     ...
     * Provider : BOB
     * Desc: Retrieve Channel Results
     * @Route("/api/touch/bill/RetrieveResults", name="api_touch_RetrieveResults",methods="POST")
     */
    public function RetrieveResultsApi(Request $request, BobServices $bobServices)
    {
        //{
        //  "invoicesId" : 43,
        //  "Pin": [1234],
        //  "mobileNumber": "03030405",
        //  "currency": "LBP"
        //}
        $data = json_decode($request->getContent(), true);
        $webkey = apache_request_headers();
     ...
     * Provider : BOB
     * Desc: Retrieve Channel Results
     * @Route("/api/touch/bill/pay", name="api_touch_bill_pay",methods="POST")
     */
     ...
     * Provider : LOTO
     * Desc: Buy PrePaid vouchers
     * @Route("/api/touch/BuyPrePaid", name="api_touch_BuyPrePaid",methods="POST")
     */
    public function BuyPrePaidApi(Request $request, LotoServices $lotoServices, NotificationServices $notificationServices)
    {
        $suyoolServices = new SuyoolServices($this->params->get('TOUCH_PREPAID_MERCHANT_ID'));
