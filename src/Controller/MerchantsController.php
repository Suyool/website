...
class MerchantsController extends AbstractController
{
    ...
    /**
     * @Route("/rim", name="rim-payroll")
     */
    public function rim(Request $request, TranslatorInterface $translatorInterface): Response
    {
        $parameters = $this->trans->translation($request, $translatorInterface);
        $translatorInterface->setLocale("en");
        $parameters['lang'] = "en";
        $parameters['metaimage'] = "build/images/payroll/rimMeta.png";
        $parameters['descmeta'] = "Why is Suyool the best option for your payroll?";
        $parameters['faq'] = [
            "ONE" => [
                "Title" => "WHAT_IS_SUYOOL_DrogueriePhenicia",
            ...
            "THREE" => [
                "Title" => "WHAT_ARE_THE_BENEFITS_FOR_USJ_EMPLOYEES_Rim",
                "Desc" => "YOU_WILL_BENEFIT_FROM_A_FREE_PLATINUM_MASTERCARD_Rim"
            ],
            "FOUR" => [
                "Title" => "IS_THERE_ANY_FEE_TO_GET_MY_SUYOOL_PLATINUM_MASTERCARD_DrogueriePhenicia",
                "Desc" => "YOUR_SUYOOL_MASTERCARD_WILL_BE_FREE_OF_CHARGE_ADDICTS_Rim"
            ],
            "FIVE" => [
                "Title" => "WHERE_CAN_I_USE_MY_SUYOOL_PLATINUM_MASTERCARD_DrogueriePhenicia",
                "Desc" => "YOU_CAN_USE_YOUR_SUYOOL_MASTERCARD_AT_ANY_POS_DrogueriePhenicia"
        ...
        $parameters['title'] = "Rim Natural Spring Mineral Water SAL | Suyool";
        $parameters['desc'] = "Facing today's financial challenges, we moved our payroll to Suyool. You will get your own digital dual-currency account,a Platinum Debit Card & a payment tool with the best rates available.";

        $parameters['infoSection'] = $this->infoSection2;

        return $this->render('rim/index.html.twig', $parameters);
    }
    /**
     * @Route("/cuisine-matters", name="cuisine-matters")
     */
    public function cuisineMatters(Request $request, TranslatorInterface $translatorInterface): Response
    {
        $parameters = $this->trans->translation($request, $translatorInterface);
        $translatorInterface->setLocale("en");
        $parameters['lang'] = "en";
        $parameters['metaimage'] = "build/images/payroll/cuisinemattersMeta.png";
        $parameters['descmeta'] = "Why is Suyool the best option for your payroll?";
        $parameters['faq'] = [
            "ONE" => [
                "Title" => "WHAT_IS_SUYOOL_DrogueriePhenicia",
            ...
            "THREE" => [
                "Title" => "WHAT_ARE_THE_BENEFITS_FOR_USJ_EMPLOYEES_Cuisine_Matters",
                "Desc" => "YOU_WILL_BENEFIT_FROM_A_FREE_PLATINUM_MASTERCARD_Cuisine_Matters"
            ],
            "FOUR" => [
                "Title" => "IS_THERE_ANY_FEE_TO_GET_MY_SUYOOL_PLATINUM_MASTERCARD_DrogueriePhenicia",
                "Desc" => "YOUR_SUYOOL_MASTERCARD_WILL_BE_FREE_OF_CHARGE_ADDICTS_Cuisine_Matters"
            ],
            "FIVE" => [
                "Title" => "WHERE_CAN_I_USE_MY_SUYOOL_PLATINUM_MASTERCARD_DrogueriePhenicia",
                "Desc" => "YOU_CAN_USE_YOUR_SUYOOL_MASTERCARD_AT_ANY_POS_DrogueriePhenicia"
        ...
        $parameters['title'] = "Cuisine Matters SAL. | Suyool";
        $parameters['desc'] = "Facing today's financial challenges, we moved our payroll to Suyool. You will get your own digital dual-currency account,a Platinum Debit Card & a payment tool with the best rates available.";

        $parameters['infoSection'] = $this->infoSection2;

        return $this->render('cuisineMatters/index.html.twig', $parameters);
    }
        /**
     * @Route("/Georges-Frem-Foundation", name="Georges-Frem-Foundation")
     */
    public function GeorgesFremFoundation(Request $request, TranslatorInterface $translatorInterface): Response
    {
        $parameters = $this->trans->translation($request, $translatorInterface);
        $translatorInterface->setLocale("en");
        $parameters['lang'] = "en";
        $parameters['metaimage'] = "build/images/payroll/georgeNMeta.png";
        $parameters['descmeta'] = "Why is Suyool the best option for your payroll?";
        $parameters['faq'] = [
            "ONE" => [
                "Title" => "WHAT_IS_SUYOOL_DrogueriePhenicia",
            ...
            "THREE" => [
                "Title" => "WHAT_ARE_THE_BENEFITS_FOR_USJ_EMPLOYEES_Georges_Frem_Foundation",
                "Desc" => "YOU_WILL_BENEFIT_FROM_A_FREE_PLATINUM_MASTERCARD_Georges_Frem_Foundation"
            ],
            "FOUR" => [
                "Title" => "IS_THERE_ANY_FEE_TO_GET_MY_SUYOOL_PLATINUM_MASTERCARD_DrogueriePhenicia",
                "Desc" => "YOUR_SUYOOL_MASTERCARD_WILL_BE_FREE_OF_CHARGE_ADDICTS_Georges_Frem_Foundation"
            ],
            "FIVE" => [
                "Title" => "WHERE_CAN_I_USE_MY_SUYOOL_PLATINUM_MASTERCARD_DrogueriePhenicia",
                "Desc" => "YOU_CAN_USE_YOUR_SUYOOL_MASTERCARD_AT_ANY_POS_DrogueriePhenicia"
        ...
        $parameters['title'] = "Georges N. Frem Foundation. | Suyool";
        $parameters['desc'] = "Facing today's financial challenges, we moved our payroll to Suyool. You will get your own digital dual-currency account,a Platinum Debit Card & a payment tool with the best rates available.";

        $parameters['infoSection'] = $this->infoSection2;

        return $this->render('georgesN/index.html.twig', $parameters);
    }

    /**
     * @Route("/sanita-persona", name="sanita-persona")
     */
    public function sanitaPersona(Request $request, TranslatorInterface $translatorInterface): Response
    {
        $parameters = $this->trans->translation($request, $translatorInterface);
        $translatorInterface->setLocale("en");
        $parameters['lang'] = "en";
        $parameters['metaimage'] = "build/images/payroll/personaSanitaMeta.png";
        $parameters['descmeta'] = "Why is Suyool the best option for your payroll?";
        $parameters['faq'] = [
            "ONE" => [
                "Title" => "WHAT_IS_SUYOOL_DrogueriePhenicia",
            ...
            "THREE" => [
                "Title" => "WHAT_ARE_THE_BENEFITS_FOR_USJ_EMPLOYEES_Sanita_Persona",
                "Desc" => "YOU_WILL_BENEFIT_FROM_A_FREE_PLATINUM_MASTERCARD_Sanita_Persona"
            ],
            "FOUR" => [
                "Title" => "IS_THERE_ANY_FEE_TO_GET_MY_SUYOOL_PLATINUM_MASTERCARD_DrogueriePhenicia",
                "Desc" => "YOUR_SUYOOL_MASTERCARD_WILL_BE_FREE_OF_CHARGE_ADDICTS_Sanita_Persona"
            ],
            "FIVE" => [
                "Title" => "WHERE_CAN_I_USE_MY_SUYOOL_PLATINUM_MASTERCARD_DrogueriePhenicia",
                "Desc" => "YOU_CAN_USE_YOUR_SUYOOL_MASTERCARD_AT_ANY_POS_DrogueriePhenicia"
        ...
        $parameters['title'] = "Sanita Persona SAL | Suyool";
        $parameters['desc'] = "Facing today's financial challenges, we moved our payroll to Suyool. You will get your own digital dual-currency account,a Platinum Debit Card & a payment tool with the best rates available.";

        $parameters['infoSection'] = $this->infoSection2;

        return $this->render('sanitaPersona/index.html.twig', $parameters);
    }
